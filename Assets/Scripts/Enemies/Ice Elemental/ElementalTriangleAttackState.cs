...
public class ElementalTriangleAttackState : ElementalState
{
    ...
    {
        GameObject attack = GameObject.Instantiate(triangleAttack, self.transform.position, Quaternion.identity);
